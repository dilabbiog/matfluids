...
% Compute the Gamma_1 criterion to identify vortex cores                  %
%                                                                         %
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
%                                                                         %
...
% SYNTAX                                                                  %
%                                                                         %
% G1 = gamma1(coord, vel, winSize);                                       %
%                                                                         %
% DESCRIPTION                                                             %
%                                                                         %
% Compute the Gamma_1 criterion using a specified window size to identify %
...
% ----------------------------------------------------------------------- %
% 'G1'           REAL ARRAY                                               %
%              ~ Gamma_1 criterion. The output will have the same size as %
...
% EXAMPLE 1                                                               %
%                                                                         %
% Compute the Gamma_1 criterion of a double gyre. Generate the double     %
...
% >> G1      = gamma1(coord, vel, 11);                                    %
% >> pcolor(coord.x, coord.y, G1(:,:,26).');                              %
% >> shading interp;                                                      %
% >> axis equal tight;                                                    %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [G1] = gamma1(coord, vel, winSize)
...
% Compute Gamma_1.
G1 = (convn(Vm, kernPMx, 'same') - convn(Um, kernPMy, 'same'))/winArea;
