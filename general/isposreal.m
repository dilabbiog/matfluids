...
% are genuine positive real numbers. Consider numbers below 10^-8 as      %
% zero.                                                                   %
%                                                                         %
% >> x   = [2 Inf 0.1 10^-12 -Inf];                                       %
% >> val = isposreal(x, 'tolRe', 10^-8);                                  %
% >> disp(val);                                                           %
%    1   1   1   0   0                                                    %
%                                                                         %
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
% are genuine positive real numbers. Use a tolerance of 10^-8 for the     %
...
% >> val = isposreal(x, 'tolIm', 10^-8, 'inf', 0);                        %
% >> disp(val);                                                           %
%    1   1   0                                                            %
%                                                                         %
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
% If the input is not logical or numeric, then it cannot be a positive real
% number. The char data type is not accepted as an integer by MATfluids.
