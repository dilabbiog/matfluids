...
% isposint                                                                %
% Data Interrogation                                                      %
% Examine data for genuine positive (nonzero) integers                    %
%                                                                         %
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
%                                                                         %
...
% val = isposint(S);                                                      %
% val = isposint(S, 'all');                                               %
% val = isposint(___, Name, Value);                                       %
%                                                                         %
% DESCRIPTION                                                             %
%                                                                         %
% Examine the elements of an input array and determine whether each is a  %
% genuine positive (nonzero) integer. The 'all' option determines whether %
% the entire input array consists only of genuine positive integers. A    %
...
% be specified as genuine positive integers or not. By default, such      %
% elements are considered to be genuine positive integers.                %
%                                                                         %
% Compatibility:                                                          %
...
%                for genuine positive integers. Data types that are not   %
...
%                array consists only of genuine positive integers.        %
% ======================================================================= %
...
%                positive integers (true, 1) or not (false, 0).           %
% ----------------------------------------------------------------------- %
% 'nan'          LOGICAL SCALAR                                           %
%                Default: true                                            %
...
% are genuine positive integers. Use a tolerance of 10^-8 for the         %
% fractional parts of real numbers and do not consider +Inf values as     %
% genuine positive integers.                                              %
%                                                                         %
% >> x   = [-2 Inf 0.1 2+10^-12];                                         %
% >> val = isposint(x, 'tolRe', 10^-8, 'inf', 0);                         %
% >> disp(val);                                                           %
%    0   0   0   1                                                        %
%                                                                         %
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
% genuine positive integers. Consider NaN values to be genuine positive   %
% integers.                                                               %
%                                                                         %
% >> x   = [1 -2 NaN Inf 0];                                              %
% >> val = isposint(x, 'all');                                            %
...
function [val] = isposint(S, varargin)
...
%% POSITIVE INTEGER INTERROGATION

% If the input is not logical nor numeric, or if the input is empty, the
% it cannot be a positive integer. The char data type is not accepted as an
...
C{2} =  hParser.Results.nan                                             ...
     ...
     & ~isnan(imag(S))                                                  ...
     & (abs(imag(S)) <= hParser.Results.tolIm);
% (Not Inf?) AND (Not NaN?) AND (No Mod?) AND (Is +?) AND (No Im?)
C{3} = ~isinf(real(S))                                                  ...
     & ~isnan(real(S))                                                  ...
...
% (+Inf?) OR (NaN?) OR (Positive Integer?)
val = C{1} | C{2} | C{3};
